                                        ...
                                        <tr>
                                            ...
                                            if($question->typeNumber == 3) {
                                                foreach ($questionAnswers as $answerKey => $answer) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="button" value="<?=$answerKey+1?>"> <textarea class="fillInTheBlank" id="answer<?=$answer->answerID?>" name="answer[<?=$question->typeNumber?>][<?=$question->questionBankID?>][<?=$answer->answerID?>]" value="" type="text"></textarea>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
